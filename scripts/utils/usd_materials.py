...
def add_materials_scope(stage: Usd.Stage, scope_path: str, materials: list[MaterialRecipe]) -> dict:
    ...
    for recipe in materials:
        ...
        if recipe.texture_path:
            ...
            texture.CreateInput("file", Sdf.ValueTypeNames.Asset).Set(Sdf.AssetPath(recipe.texture_path))
        ...
        if recipe.kind in ("metal", "metal_tex"):
            ...
            shader.CreateInput("spatialCheckerCellSize", Sdf.ValueTypeNames.Float).Set(recipe.checker_cell_size)
