...
inline bool intersectTriangle(const Ray& ray, const Point3& vertex0, const Point3& vertex1,
                              const Point3& vertex2, float minDistance, float maxDistance,
                              float& outDistance, float& outBarycentricU, float& outBarycentricV)
{
